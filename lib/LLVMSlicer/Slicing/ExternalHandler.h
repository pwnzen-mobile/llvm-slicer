...
void anonymous_1005(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
  // Handle "malloc"
}

void anonymous_1008(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1019(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1030(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1036(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1042(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
  // Handle "-[UILabel text]"
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
...
void anonymous_1048(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1057(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_106(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_1069(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1081(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1088(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1095(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
  // Handle "+[NSNull null]"
}

void anonymous_1098(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
  // Handle "+[UIApplication sharedApplication]"
}

void anonymous_1101(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1108(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1115(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1121(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1127(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
  // Handle "-[NSDictionary objectForKey:]"
}

void anonymous_1131(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_1138(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
  // Handle "-[NSDictionary valueForKey:]"
}

void anonymous_1142(llvm::slicing::InsInfo *CallInst,
                    const ptr::PointsToSets &PS) {
...
void anonymous_119(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_132(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_145(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_148(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "-[NSData writeToFile:options:error:]"
}

void anonymous_149(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_162(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_17(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_170(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_18(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_183(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_19(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_196(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_20(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_209(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_21(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_22(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_222(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_23(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_235(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_24(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
  // Handle "objc_release"
}

void anonymous_243(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_25(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
  // Handle "-[NSObject release]"
}

void anonymous_251(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_26(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
  // Handle "-[NSObject dealloc]"
}

void anonymous_260(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_266(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_27(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_277(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_288(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_299(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_311(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_323(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_33(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_332(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "-[NSString
...
void anonymous_341(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_350(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_361(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_372(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_383(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_389(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_398(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_404(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_410(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_416(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_422(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_428(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_435(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "-[NSDictionary objectForKey:]"
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
...
void anonymous_442(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "-[NSDictionary valueForKey:]"
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
...
void anonymous_449(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_455(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_46(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_464(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_470(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_476(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_482(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_488(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "-[NSData bytes]"
  { // Ref1
    DetectParametersPass::UserSet_t RefRegs;
...
void anonymous_500(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_517(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_537(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_550(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_553(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_565(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_577(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_580(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_59(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
  // Handle "+[NSData data]"
  { // Def
    DetectParametersPass::UserSet_t DefRegs =
...
void anonymous_593(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "memcpy"
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
...
void anonymous_604(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "CCKeyDerivationPBKDF"
  { // Ref
    DetectParametersPass::UserSet_t RefRegs =
        DetectParametersPass::getRegisterValuesBeforeCall(
            translateRegister("X0"), (Instruction *)CallInst->getIns(), true);
    for (auto RefRegs_it = RefRegs.begin(); RefRegs_it != RefRegs.end();
         ++RefRegs_it) {
      CallInst->addREF(llvm::ptr::PointsToSets::Pointee(*RefRegs_it, -1));
    }
  ...
  { // Ref
    DetectParametersPass::UserSet_t RefRegs =
        DetectParametersPass::getRegisterValuesBeforeCall(
            translateRegister("X1"), (Instruction *)CallInst->getIns(), true);
    for (auto RefRegs_it = RefRegs.begin(); RefRegs_it != RefRegs.end();
         ++RefRegs_it) {
      CallInst->addREF(llvm::ptr::PointsToSets::Pointee(*RefRegs_it, -1));
    }
  ...
  { // Ref
    DetectParametersPass::UserSet_t RefRegs =
        DetectParametersPass::getRegisterValuesBeforeCall(
            translateRegister("X7"), (Instruction *)CallInst->getIns(), true);
    for (auto RefRegs_it = RefRegs.begin(); RefRegs_it != RefRegs.end();
         ++RefRegs_it) {
      CallInst->addREF(llvm::ptr::PointsToSets::Pointee(*RefRegs_it, -1));
    }
  ...
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
    {
      DetectParametersPass::UserSet_t Src =
          DetectParametersPass::getRegisterValuesBeforeCall(
              translateRegister("X7"), (Instruction *)CallInst->getIns());
      for (auto S : Src) {
        const ptr::PointsToSets::PointsToSet &PtsTo =
            ptr::getPointsToSet(S, PS); // get points to sets
        for (auto &P : PtsTo) {
...
void anonymous_621(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  ...
  { // Ref1
    DetectParametersPass::UserSet_t RefRegs =
        DetectParametersPass::getRegisterValuesBeforeCall(
            translateRegister("X5"), (Instruction *)CallInst->getIns());
    for (auto RefRegs_it = RefRegs.begin(); RefRegs_it != RefRegs.end();
         ++RefRegs_it) {
      CallInst->addREF(llvm::ptr::PointsToSets::Pointee(*RefRegs_it, -1), 1.0);
    }
...
void anonymous_626(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "CCCryptorCreate"
}

void anonymous_627(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  ...
  { // Ref1
    DetectParametersPass::UserSet_t RefRegs;
    {
      DetectParametersPass::UserSet_t Src =
          DetectParametersPass::getRegisterValuesBeforeCall(
              translateRegister("X4"), (Instruction *)CallInst->getIns());
      for (auto S : Src) {
        const ptr::PointsToSets::PointsToSet &PtsTo =
            ptr::getPointsToSet(S, PS); // get points to sets
        for (auto &P : PtsTo) {
...
void anonymous_631(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "CCCrypt"
}

void anonymous_632(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  ...
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
    {
      DetectParametersPass::UserSet_t Src =
          DetectParametersPass::getRegisterValuesBeforeCall(
              translateRegister("X3"), (Instruction *)CallInst->getIns());
      for (auto S : Src) {
        const ptr::PointsToSets::PointsToSet &PtsTo =
            ptr::getPointsToSet(S, PS); // get points to sets
        for (auto &P : PtsTo) {
...
void anonymous_645(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_654(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_668(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_67(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_680(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_692(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_704(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_718(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_731(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "+[NSArray arrayWithArray:]"
}

void anonymous_734(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "+[NSArray arrayWithObject:]"
}

void anonymous_735(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "+[NSArray arrayWithObjects:]"
}

void anonymous_736(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "+[NSArray array]"
}

void anonymous_737(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_747(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_757(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_763(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_764(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_765(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_771(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_772(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_774(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "+[NSString stringWithCString:encoding:]"
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
...
void anonymous_781(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_788(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_789(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_790(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_791(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_792(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_793(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "-[NSData init]"
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
...
void anonymous_794(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_795(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_796(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "-[NSString initWithData:encoding:]"
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
...
void anonymous_797(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_798(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_799(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_8(llvm::slicing::InsInfo *CallInst,
                 const ptr::PointsToSets &PS) {
  // Handle "objc_retain"
  { // Ref
    DetectParametersPass::UserSet_t RefRegs =
...
void anonymous_80(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_800(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_801(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "-[NSData initWithBytes:length:]"
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
...
void anonymous_810(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "-[NSData initWithBase64EncodedString:options:]"
  { // Ref1
    DetectParametersPass::UserSet_t RefRegs;
...
void anonymous_816(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_825(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_834(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "-[NSData copy]"
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
...
void anonymous_843(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_847(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_857(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_864(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "arc4random"
  { // Def
    DetectParametersPass::UserSet_t DefRegs =
...
void anonymous_870(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_878(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_888(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_898(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_907(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "bzero"
  { // Def
    DetectParametersPass::UserSet_t DefRegs =
...
void anonymous_915(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_923(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_924(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_925(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "NSLog"
}

void anonymous_926(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "__stack_chk_fail"
}

void anonymous_927(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "objc_enumerationMutation"
}

void anonymous_928(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "objc_terminate"
}

void anonymous_929(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "objc_sync_exit"
}

void anonymous_93(llvm::slicing::InsInfo *CallInst,
                  const ptr::PointsToSets &PS) {
...
void anonymous_930(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "objc_sync_enter"
}

void anonymous_931(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "objc_exception_rethrow"
}

void anonymous_932(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "objc_exception_throw"
}

void anonymous_933(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "objc_destroyWeak"
}

void anonymous_934(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "objc_end_catch"
}

void anonymous_935(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "objc_begin_catch"
}

void anonymous_936(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "_Znam"
  { // Def
    DetectParametersPass::UserSet_t DefRegs =
...
void anonymous_941(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "_Znwm"
  { // Def
    DetectParametersPass::UserSet_t DefRegs =
...
void anonymous_946(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_951(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "CC_MD5"
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
...
void anonymous_958(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "CC_SHA256"
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
...
void anonymous_965(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "read"
  { // Def
    DetectParametersPass::UserSet_t DefRegs;
...
void anonymous_971(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
  // Handle "open"
  { // Def
    DetectParametersPass::UserSet_t DefRegs =
...
void anonymous_977(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_987(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_993(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
void anonymous_999(llvm::slicing::InsInfo *CallInst,
                   const ptr::PointsToSets &PS) {
...
bool handleCall(llvm::slicing::InsInfo *CallInst, std::string FName,
                const ptr::PointsToSets &PS) {
