...
llvm::AliasResult AndersenAA::andersenAlias(const llvm::Value *v1,
                                            const llvm::Value *v2) {
...
llvm::AliasResult AndersenAA::alias(const MemoryLocation &l1,
...
bool AndersenAA::pointsToConstantMemory(const MemoryLocation &loc,
                                        bool orLocal) {
...
// static RegisterPass<AndersenAA> X("anders-aa", "Andersen Alias Analysis",
// true, true); static RegisterAnalysisGroup<AliasAnalysis> Y(X);
